...
//        => optionsBuilder.UseSqlServer("Server=GERO\\SQLEXPRESS01;Initial Catalog=Almacen;integrated security=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.Documento).HasName("PK__Clientes__AF73706CD980E3A3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Compras__3214EC078B1CD7DF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producto__3214EC0762159AAA");
